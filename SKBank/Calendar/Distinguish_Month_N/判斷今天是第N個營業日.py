...
def main(TxtName):
    ...
    (os.path.isfile(os.path.join(os.getcwd(),'Test', 'Config.txt'))):
    ...
    #TODO: 判斷今天為第n個營業日
    n = len(list_month_n)-1
    print('今天為第{}個營業日'.format(n))
    with open(TxtName, mode="w", encoding="utf-8") as file: file.write(str('今天為第{}個營業日'.format(n)).strip()+'\n')
